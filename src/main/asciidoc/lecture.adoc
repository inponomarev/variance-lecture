...
"MyList<out Employee>" <|-- "MyList<Employee>"

"MyList<out Employee>" <|-- "MyList<Manager>"
...
"MyList<in Employee>" <|-- "MyList<Employee>"

"MyList<in Employee>" <|-- "MyList<Person>"
