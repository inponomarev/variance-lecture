...
== Type variance (invariance, covariance, contravariance)



* "It sounds scary. Do I need to know it?"
...
* I will show the full evolution from historical perspective: from Java typed arrays through Java generics to Kotlin generics
* Thus it will be a walk from simple to complex stuff
